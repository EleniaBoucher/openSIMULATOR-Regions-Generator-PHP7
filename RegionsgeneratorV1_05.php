...
<form class="w3-container" action="" method="post">
    ...
    <label for="base" class="w3-label w3-text-blue control-label">Regionsname :</b></label>
        <div class="col-sm-4">
	...
	<div class="form-group">
    <label for="base" class="w3-label w3-text-blue control-label">Lokalisation X :</b></label>
        <div class="col-sm-4">
 	...
 	<div class="form-group">
    <label for="base" class="w3-label w3-text-blue control-label">Lokalisation Y :</b></label>
        <div class="col-sm-4">
 	...
 	<div class="form-group">
    <label for="base" class="w3-label w3-text-blue control-label">Port :</b></label>
        <div class="col-sm-4">
 	...
 	<div class="form-group">
    <label for="base" class="w3-label w3-text-blue control-label">Externe IP Adresse :</b></label>
        <div class="col-sm-4">
 	...
 	<div class="form-group">
    <label for="base" class="w3-label w3-text-blue control-label">Regionsgröße in Meter :</b></label>
        <div class="col-sm-4">
 	...
 	<div class="form-group">
    <label for="base" class="w3-label w3-text-blue control-label">Landepunkt x,y,z :</b></label>
        <div class="col-sm-4">
 	...
 	<div class="form-group">
    <label for="base" class="w3-label w3-text-blue control-label">Prim Größe in Meter :</b></label>
        <div class="col-sm-4">
 	...
 	<div class="form-group">
    <label for="base" class="w3-label w3-text-blue control-label">Maximum an Prims :</b></label>
        <div class="col-sm-4">
 	...
 	<div class="form-group">
    <label for="base" class="w3-label w3-text-blue control-label">Maximum an Besucher :</b></label>
        <div class="col-sm-4">
 	...
 	<div class="form-group">
    <label for="base" class="w3-label w3-text-blue control-label">Besitzer Vorname :</b></label>
        <div class="col-sm-4">
 	...
 	<div class="form-group">
    <label for="base" class="w3-label w3-text-blue control-label">Besitzer Nachname :</b></label>
        <div class="col-sm-4">
 	...
 	<div class="form-group">
    <label for="base" class="w3-label w3-text-blue control-label">Max Prims Pro Benutzer (Unbegrenzt = -1) :</b></label>
        <div class="col-sm-4">
 	...
 	<div class="form-group">
    <label for="base" class="w3-label w3-text-blue control-label">Regionsanzahl X :</b></label>
        <div class="col-sm-4">
    <input class="w3-input w3-border" type="test" placeholder="1" name="osRegionsanzahlx" maxlength="40" />
        </div>
    </div> 
	
 	<div class="form-group">
    <label for="base" class="w3-label w3-text-blue control-label">Regionsanzahl Y :</b></label>
        <div class="col-sm-4">
    <input class="w3-input w3-border" type="test" placeholder="1" name="osRegionsanzahly" maxlength="40" />
        </div>
    </div> 
<br>
...
<!-- Install Button -->
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            <button class="w3-btn-block w3-blue" type="submit" name="submit" value="Installer">Erstellen</button>
        </div>
    </div>
